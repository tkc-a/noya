...
<!-- wp:columns {"style":{"color":{"background":"#f5f6f7"},"spacing":{"padding":{"right":"var:preset|spacing|space-xl","left":"var:preset|spacing|space-xl"}}}} -->
<div class="wp-block-columns has-background"
    style="background-color:#f5f6f7;padding-right:var(--wp--preset--spacing--space-xl);padding-left:var(--wp--preset--spacing--space-xl)">
    <!-- wp:column {"style":{"spacing":{"padding":{"right":"0","left":"0","bottom":"var:preset|spacing|space-xl"}},"border":{"radius":"8px"}},"backgroundColor":"base"} -->
    <div class="wp-block-column has-base-background-color has-background"
        style="border-radius:8px;padding-right:0;padding-bottom:var(--wp--preset--spacing--space-xl);padding-left:0">
        <!-- wp:heading {"style":{"spacing":{"margin":{"left":"var:preset|spacing|space-xl","top":"var:preset|spacing|space-md"}}},"fontSize":"font-lg"} -->
        <h2 class="wp-block-heading has-font-lg-font-size"
            style="margin-top:var(--wp--preset--spacing--space-md);margin-left:var(--wp--preset--spacing--space-xl)">404
            Not Found</h2>
        <!-- /wp:heading -->

        <!-- wp:image {"sizeSlug":"full","linkDestination":"none","className":"is-style-default","style":{"spacing":{"margin":{"right":"var:preset|spacing|space-xl","left":"var:preset|spacing|space-xl"}}}} -->
        <figure class="wp-block-image size-full is-style-default"
            style="margin-right:var(--wp--preset--spacing--space-xl);margin-left:var(--wp--preset--spacing--space-xl)">
            <img /></figure>
        <!-- /wp:image -->

        <!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|space-xl","left":"var:preset|spacing|space-xl"}}},"layout":{"type":"constrained"}} -->
        <div class="wp-block-group"
            style="padding-right:var(--wp--preset--spacing--space-xl);padding-left:var(--wp--preset--spacing--space-xl)">
            <!-- wp:paragraph -->
            <p><?php /* Translators: 1. is a 'br' HTML element */ 
echo sprintf( esc_html__( 'ブログをご覧いただきありがとうございます。%1$sお探しのページは移動または削除された可能性があります。', 'noya' ), '<br>' ); ?></p>
            <!-- /wp:paragraph -->

            <!-- wp:paragraph -->
            <p><?php esc_html_e('検索フォームにキーワードを入れてもう一度検索してください。', 'noya');?></p>
            <!-- /wp:paragraph -->

            <!-- wp:search {"label":"検索","showLabel":false,"placeholder":"キーワードを検索..","buttonText":"検索","buttonUseIcon":true,"style":{"border":{"radius":"8px"}}} /-->
        </div>
        <!-- /wp:group -->
    </div>
    <!-- /wp:column -->
    ...
    <div class="wp-block-column" style="flex-basis:360px">
        ...
        <div class="wp-block-group has-base-background-color has-background"
            ...
            <figure class="wp-block-image aligncenter size-full is-resized is-style-image-border-circle"><img src=""
            ...
            <div class="wp-block-group"><!-- wp:columns {"verticalAlignment":"top"} -->
                <div class="wp-block-columns are-vertically-aligned-top">
                    ...
                    <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:40px">
                        ...
                        <figure class="wp-block-image size-thumbnail is-resized is-style-image-border-circle"><img src="" alt=""
                    ...
                    <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:40px">
                        ...
                        <figure
                            ...
                            <img src="" alt="" style="width:40px" /></figure>
                        <!-- /wp:image -->
                    </div>
                    <!-- /wp:column -->
                    ...
                    <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:40px">
                        ...
                        <figure class="wp-block-image size-thumbnail is-resized is-style-image-border-circle"><img
                                src="" alt="" style="width:40px" /></figure>
                        <!-- /wp:image -->
                    </div>
                    <!-- /wp:column -->
                </div>
